  ...
  return (
    <div className="2xl:container mx-auto">
      <div className="relative">
        {/* Background Image */}
        <div className="hidden lg:block absolute top-14 right-0 w-5/12">
          <Image
          ...
          <div className="w-full lg:w-7/12 mr-4 ml-4">
            ...
            <div className="relative flex justify-center items-center mt-8 sm:mt-14 z-10 h-36">
              ...
              <button
                ...
                className={`absolute left-2 sm:left-10 lg:left-16 z-10 bg-white p-1 rounded-full shadow-md ${currentSlide === 0 ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'
                  }`}
              >
              ...
              {/* Slider Images */}
              <div className="flex gap-6 justify-center overflow-hidden mx-8 h-full" ref={sliderRef}>
              ...
              <button
                ...
                className={`absolute right-2 sm:right-10 lg:right-16 z-10 bg-white p-1 rounded-full shadow-md ${currentSlide >= product.images.length - 3 ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'
                  }`}
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
