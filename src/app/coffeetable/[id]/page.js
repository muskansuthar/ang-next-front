                    ...
                    <div className="w-full lg:w-8/12 mr-2 ml-2">
                        ...
                        <div className="relative flex justify-center items-center mt-8 sm:mt-14 z-10">
                            ...
                            <button
                                ...
                                className={`absolute left-2 sm:left-10 lg:left-10 z-10 bg-white p-1 rounded-full shadow-md ${currentSlide === 0 ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'
                                    }`}
                            >
                            ...
                            <button
                                ...
                                className={`absolute right-2 sm:right-10 lg:right-10 z-10 bg-white p-1 rounded-full shadow-md ${currentSlide >= product.images.length - 3 ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'
                                    }`}
                            >
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
